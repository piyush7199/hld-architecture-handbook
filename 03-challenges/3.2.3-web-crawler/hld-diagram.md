...
This diagram shows the complete end-to-end architecture of the distributed web crawler system, from seed URLs to stored
content.
...
Two-tier duplicate detection combines Bloom Filter (fast, memory-efficient) with Redis (accurate, persistent) to
minimize memory usage while ensuring correctness.
