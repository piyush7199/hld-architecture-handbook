...
- **[2.3.2 Apache Kafka](../../02-components/2.3-messaging-streaming/2.3.2-kafka-deep-dive.md)**
- **[2.3.8 Apache Flink](../../02-components/2.3-messaging-streaming/2.3.8-apache-flink-deep-dive.md)**
- **[2.1.11 Redis](../../02-components/2.1-databases/2.1.11-redis-deep-dive.md)**
- **[2.1.9 Cassandra](../../02-components/2.1-databases/2.1.9-cassandra-deep-dive.md)**
...
- **[3.5.2 Ad Click Aggregator](../3.5.2-ad-click-aggregator/3.5.2-design-ad-click-aggregator.md)** - Similar stream
  processing patterns
