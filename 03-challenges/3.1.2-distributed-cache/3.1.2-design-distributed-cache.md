...
> This document focuses on high-level design concepts and architectural decisions. For detailed algorithm implementations (Consistent Hashing, LRU Cache, Replication, TTL Management, etc.), see **[pseudocode.md](./pseudocode.md)**.
