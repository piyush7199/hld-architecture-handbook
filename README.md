...
| 3.4.3      | **Design a Distributed Monitoring System**                                                                  | $\text{Time}$-$\text{Series}$ $\text{Databases}$ ($\text{TSDB}$), $\text{Rollup}$ $\text{Aggregations}$, $\text{Stream}$ $\text{Alerting}$.                                                                                                               |
| 3.4.4      | **Design a Recommendation System**                                                                          | $\text{Lambda}$ $\text{Architecture}$, $\text{Feature}$ $\text{Stores}$, $\text{Vector}$ $\text{Embeddings}$, $\text{Real}$-$\text{Time}$ $\text{Serving}$.                                                                                               |
| 3.4.5      | **Design a Stock Brokerage Platform**                                                                       | $\text{ACID}$ $\text{Ledgers}$, $\text{Real}$-$\text{Time}$ $\text{Data}$ $\text{Push}$, $\text{Geo}$-$\text{Sharding}$, $\text{Order}$ $\text{Entry}$ $\text{Flows}$.                                                                                    |
