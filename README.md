...
| 3.5.1      | [**Design a Collaborative Editor**](03-challenges/3.4.6-collaborative-editor/) ($\text{Google}$ $\text{Docs}$)                | $\text{OT}$/$\text{CRDT}$, $\text{WebSockets}$, $\text{Event}$ $\text{Sourcing}$, $\text{CQRS}$.                                                                                                                                                                              |
| 3.5.2      | **Design an Online Code Editor / Judge**                                                                                      | $\text{Execution}$ $\text{Isolation}$ ($\text{Sandboxing}$), $\text{Queue}$ $\text{Priority}$, $\text{Resource}$ $\text{Throttling}$.                                                                                                                                         |
| 3.5.3      | **Design a Video Streaming System** ($\text{YouTube}$ / $\text{Netflix}$)                                                     | $\text{CDN}$ $\text{Hierarchy}$, $\text{DASH}$/$\text{HLS}$, $\text{Encoding}$ $\text{Pipelines}$, $\text{DRM}$.                                                                                                                                                              |
